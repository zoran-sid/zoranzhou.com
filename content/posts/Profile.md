...
• Identified 3 critical issues (plaintext credential transmission, misconfigured cloud storage buckets, leaked webpack source code) and executed 23 manual penetration test items in line with enterprise security standards.
...
• Coordinated remediation on 1,001 endpoints, closing 962/1,756 high-risk and 2,308/4,297 medium-risk vulnerabilities through structured patch management and configuration hardening.
...
• Conducted penetration testing on 16 core web applications, fixing 21/22 high- and 17/20 medium-severity issues (SQL injection, XSS, authentication flaws) and standardizing firewall and security device configurations.
...
**Skills**: MPLS/BGP routing & VLAN design; Campus & SDN network architecture; Penetration testing (Metasploit, Burp Suite, SQLMap); Vulnerability assessment & remediation; IDS/IPS & SIEM operation; Firewall management; Network traffic analysis; Python & Shell scripting for network/security automation.
